...
_KEYWORD_MAP: dict[SubTopic, list[str]] = {
    ...
    SubTopic.DEBT_MANAGEMENT: [
        "deuda", "debt", "crédito personal", "refinanciación", "préstamo",
    ],
    ...
    SubTopic.FCIS: [
        "fondo común", "fondo de inversión", "fci", "fondos comunes", "mutual fund",
    ],
    SubTopic.ETFS: ["etf", "etfs", "exchange traded fund"],
    SubTopic.CRYPTO: ["crypto", "bitcoin", "ethereum", "criptomoneda", "criptoactivo"],
    SubTopic.MUTUAL_FUNDS: ["fondo mutuo", "mutual fund", "fondo de inversión colectiva"],
    # Tax & Regulation
    ...
    SubTopic.CURRENCY_CONTROLS: [
        "cepo", "mep", "ccl", "dólar blue", "controles cambiarios",
        "currency control", "tipo de cambio", "cotización",
    ],
    SubTopic.INFLATION: [
        "inflación", "inflation", "ipc", "cpi", "indec", "precio", "precios",
    ],
    SubTopic.REGULATORY_BODIES: [
        "bcra", "cnv", "afip", "uif", "comisión nacional de valores",
        "banco central", "regulador",
    ],
    SubTopic.TAX_PLANNING: [
        "planificación fiscal", "tax planning", "evasión", "elusión", "declaración",
    ],
    # Real Estate
    SubTopic.MORTGAGE: ["hipoteca", "mortgage", "crédito hipotecario"],
    SubTopic.RENTAL: ["alquiler", "rental", "inquilino", "arrendamiento"],
    SubTopic.PROPERTY_TAX: ["abl", "inmobiliario", "property tax", "impuesto inmobiliario"],
}
